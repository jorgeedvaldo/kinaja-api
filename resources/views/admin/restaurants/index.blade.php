            ...
            <tr>
                ...
                <td>
                    <div style="display:flex;gap:8px;align-items:center">
                        ...
                        <form method="POST" action="{{ route('admin.restaurants.destroy', $restaurant) }}" style="margin:0;display:inline" onsubmit="return confirm('Tem certeza que deseja apagar este restaurante?')">
                            @csrf
                            @method('DELETE')
