...
<div class="app-shell">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section-label" style="margin-top: 12px; padding-top: 12px; border-top: 1px solid var(--border);">Aprovações</div>
            <a class="nav-item {{ request()->routeIs('admin.driver_applications.*') ? 'active' : '' }}" href="{{ route('admin.driver_applications.index') }}">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
                <span>Candidaturas Motoristas</span>
            </a>
            <a class="nav-item {{ request()->routeIs('admin.restaurant_applications.*') ? 'active' : '' }}" href="{{ route('admin.restaurant_applications.index') }}">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
                <span>Candidaturas Restaurantes</span>
            </a>
            @endif
        </nav>
